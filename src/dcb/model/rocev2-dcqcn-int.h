...
#ifndef ROCEV2_DCQCN_INT_H
#define ROCEV2_DCQCN_INT_H
 ...
 */
class RoCEv2DcqcnInt : public RoCEv2CongestionOps
{
  public:
    /**
     * Get the type ID.
    ...
    RoCEv2DcqcnInt();
    RoCEv2DcqcnInt(Ptr<RoCEv2SocketState> sockState);
    ~RoCEv2DcqcnInt() override;
